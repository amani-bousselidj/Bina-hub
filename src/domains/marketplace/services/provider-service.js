...
var AnalyticsProviderService = /** @class */ (function () {
    function AnalyticsProviderService(container) {
        var analyticsProviderKeys = Object.keys(container).filter(function (k) {
            return k.startsWith(exports.AnalyticsProviderRegistrationPrefix);
        });
    ...
    AnalyticsProviderService.getRegistrationIdentifier = function (providerClass, optionName) {
        return "".concat(providerClass.identifier, "_").concat(optionName);
    };
    AnalyticsProviderService.prototype.track = function (data) {
    ...
    AnalyticsProviderService.prototype.identify = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AnalyticsProviderService.prototype.shutdown = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, ((_b = (_a = this.analyticsProvider_).shutdown) === null || _b === void 0 ? void 0 : _b.call(_a))];
                    case 1:
                        _c.sent();
                        return [2 /*return*/];
                }
