...
export function OrderAllocateItemsItem({
  ...
  return (
    <div className="bg-ui-bg-subtle shadow-elevation-card-rest my-2 min-w-[720px] divide-y divide-dashed rounded-xl">
            ...
            <div className="text-ui-fg-subtle txt-small mr-2 flex flex-row items-center gap-2">
              <Form.Field
                ...
                rules={{
                  ...
                  min: !hasInventoryKit && minValue ? { value: minValue, message: "Value too low" } : undefined,
                  max: maxValue ? { value: maxValue, message: "Value too high" } : undefined,
                }}
                render={({ field }) => {
                  return (
                    <Form.Item>
      ...
      {isOpen &&
        variant?.inventory?.map((i: any, ind: number) => {
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-ui-fg-muted">
                    {t("orders.allocateItems.requires", {
                      num: variant.inventory_items?.[ind]?.required_quantity || 1,
                    })}
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-row justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-ui-fg-subtle txt-small mr-1 flex flex-row items-center gap-2">
                    ...
                    /{" "}
                    {item.quantity *
                      (variant?.inventory_items?.[ind]?.required_quantity || 1)}{" "}
                    {t("fields.qty")}
                  </div>
                </div>
              </div>
