          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('establishedYear', e.target.value)}
                min="1980"
                max="2025"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('taxNumber', e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('bankAccount', e.target.value)}
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('socialMedia.twitter', e.target.value)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleInputChange('socialMedia.linkedin', e.target.value)}
